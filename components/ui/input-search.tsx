  ...
  return (
    <div className={clsx(className, "relative w-full")} ref={inputSearchRef}>
      ...
      {showSearchEngine && !isEmpty(data?.getSearchs) && (
        <ul className="min-w-[500px] animate-in fade-in-0 zoom-in-95 absolute top-11 z-10 w-full rounded-lg outline-none bg-gray-100 dark:bg-gray-900 p-2 shadow-lg">
          {loading ? (
